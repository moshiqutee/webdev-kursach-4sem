...
/* добавляем размытие на шапку*/
const blurHeader = () =>{
    const header = document.getElementById('header')
    /* если пролистали вниз - добавляем класс размытой шапки к шапке*/
...
/* анимация при прокрутке и не только */
const sr = ScrollReveal({
    ...
    duration: 2500,
    delay: 300,
    reset: true, //сброс и повтор анимации
})
...
sr.reveal(`.favorite__card img`, { interval: 100, rotate: {z: 15}, scale: 0.7, distance: 0})
